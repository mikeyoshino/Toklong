...
namespace Toklong.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260731110000_HardenAccountNameVerification")]
    partial class HardenAccountNameVerification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Toklong.Domain.Accounts.AccountNameChangeAuditEvent", b =>
                {
                    ...
                    b.Property<string>("LegacyNewNameDigest")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("LegacyOldNameDigest")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.Property<byte[]>("ProtectedNameEvidence")
                        .HasColumnType("bytea");
            ...
            modelBuilder.Entity("Toklong.Domain.Accounts.AccountNameVerificationOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("ProviderCompletedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("ProviderObservedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("ProviderRequestedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("ProviderVerificationKey")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.HasIndex("ProviderVerificationKey")
                        .IsUnique();

                    b.HasIndex("ChallengeId", "IdempotencyKey")
                        .IsUnique();

                    b.ToTable("account_name_verification_operations", (string)null);
                });
